...
/**
 * This is the model class for table "shelter_coordinators".
 *
 * The followings are the available columns in table 'shelter_coordinators':
 * @property string $shelter_id
 * @property string $user_id
 */
class ShelterCoordinators extends CActiveRecord
{
	/**
	 ...
	 * @return ShelterCoordinators the static model class
	 */
